...
```mermaid
graph TD
    Client[Client / Dashboard] -->|HTTPS via Cloudflare| Integrator[Integrator Service (Gateway)]
...
Integrator	Lead / DevOps	API Gateway, Normalization, Docker Ops
2025 © Banyuwangi Marketplace Team. Built with Node.js & Docker.
```